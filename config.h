...
static Key keys[] = {
	...
	{ MODKEY,			XK_a,		spawn,		SHCMD("pavucontrol; pkill -RTMIN+10 dwmblocks") },
	...
	{ MODKEY|ShiftMask,	XK_F1,		spawn,		SHCMD("st -e nvim $SCRATCHCOMMAND") },
	{ MODKEY,	XK_F1,		spawn,		SHCMD("$SCRATCHCOMMAND") },
	{ MODKEY,			XK_F2,		quit,		{0} },
